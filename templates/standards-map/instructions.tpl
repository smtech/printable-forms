...
<div class="container">
	...
	<ol>
		<li>Install the bookmarklet, by dragging this bookmarklet to your bookmarks bar:<br />
			<span class="label label-primary bookmarklet"><a href="{$bookmarklet}">Generate Map</a></span>
		</li>
